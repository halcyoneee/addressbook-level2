...
== Deleting multiple persons : `deletemulti`

Deletes the specified list of persons from the address book. Irreversible. +
Format: `deletemulti [INDEX]...`
...
* `find Betsy Dickson Charlie` +
`deletemulti 3 1` +
Deletes the 1st and 3rd person in the results of the `find` command.
